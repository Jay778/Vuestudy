...
var _article_detail = _interopRequireDefault(__webpack_require__(/*! ./pages/article_detail/article_detail.vue */ "../../../../Vuestudy/jianyue/pages/article_detail/article_detail.vue"));
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ "./node_modules/@dcloudio/vue-cli-plugin-uni/packages/megalo/dist/megalo.mp.esm.js"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
_article_detail.default.mpType = 'page';
var app = new _vue.default(_article_detail.default);
app.$mount();
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("text", { staticClass: "article-title", attrs: { _hid: 1 } }, [
        _vm._v(_vm._s(_vm.article.title), 2)
      ]),
      _c("view", { staticClass: "article-info", attrs: { _hid: 3 } }, [
        _c("view", { staticClass: "left", attrs: { _hid: 4 } }, [
          _c("image", {
            staticClass: "avatar_small",
            attrs: { src: _vm.article.avatar, _hid: 5, _batrs: "src" }
          }),
          _c("text", { attrs: { _hid: 6 } }, [
            _vm._v(_vm._s(_vm.article.nickname), 7)
          ]),
          _c("text", { staticClass: "info-text", attrs: { _hid: 8 } }, [
            _vm._v(_vm._s(_vm.handleTime(_vm.article.createTime)), 9)
          ])
        ]),
        _c(
          "view",
          { staticClass: "right", attrs: { _hid: 10 } },
          [
            _vm._ri(!!(_vm.userId != _vm.article.uId && !_vm.followed), 11)
              ? _c(
                  "button",
                  {
              ...
              : _vm._e(),
            _vm._ri(!!(_vm.userId != _vm.article.uId && _vm.followed), 13)
              ? _c(
                  "button",
                  {
                    staticClass: "green-btn follow-btn cancel",
      ...
      _c("text", { staticClass: "info-text", attrs: { _hid: 17 } }, [
        _vm._v("评论" + _vm._s(_vm.comments.length), 18)
      ]),
      _vm._l(
        _vm.comments,
        function(comment, index, comment_i2) {
          var _fid = comment_i2 !== undefined ? comment_i2 : index
          return _c(
            "view",
            {
              key: index,
            ...
            [
              _c(
                "view",
                { staticClass: "left", attrs: { _hid: 20, _fid: _fid } },
                [
                  _c("image", {
                    staticClass: "avatar_small",
                    attrs: {
              ...
              _c(
                "view",
                { staticClass: "right", attrs: { _hid: 22, _fid: _fid } },
                [
                  _c("text", { attrs: { _hid: 23, _fid: _fid } }, [
                    _vm._v(_vm._s(comment.nickname), 24, _fid)
                  ]),
                  _c("text", { attrs: { _hid: 25, _fid: _fid } }, [
                    _vm._v(_vm._s(comment.content), 26, _fid)
                  ]),
                  _c("view", { attrs: { _hid: 27, _fid: _fid } }, [
                    ...
                    _c("text", { attrs: { _hid: 30, _fid: _fid } }, [
                      _vm._v(
                        _vm._s(_vm.handleTime(comment.commentTime)),
                        31,
                        _fid
                      )
                    ])
...
//# sourceMappingURL=../../../.sourcemap/mp-baidu/pages/article_detail/article_detail.js.map